...
public class Expense50UpRatioRule {

    public Expense50UpRatioRule() {
        super();
    }

    @Given
    public boolean given(Double expenseRatio) {
        return expenseRatio > 0.50;
    }

    @Then
    public void then(LoanDecision decision) {
        decision.setDecision(LoanDecision.DECISION.DECLINED);
        decision.setDecisionReasonCode(DeclineReasons.EXPENSE_RATIO_OVER_50);
    }
}
